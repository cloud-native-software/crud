...
public class CustomRepository {
    ...
    public List<Student> getQueryResult(List<Filter> filters, Pageable pageable) {
        if (filters.size() > 0) {
            return studentRepository.findAll(getSpecificationFromFilters(filters), pageable).get().toList();
        } else {
